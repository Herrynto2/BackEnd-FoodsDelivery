...
const app = user()
const { getProfileResto, getListResto, addResto, editResto, deleteResto, addCategory, checkCategory, getcategory, editCategory, delCategory } = require('../controllers/resto')
...
app.post('/categories/:id', checktoken, checkPermission.admin, addCategory); //admin : add category item 
...
app.delete('/categories/:id', checktoken, checkPermission.admin, delCategory);
